...
var MessageController = function () {
    var blockUI = function (options) {
        ...
        if (options.animate) {
            ...
            html = '<div class="loading-message ' +
                (options.boxed ? 'loading-message-boxed' : '') +
                '"></div>';/* <img src="~/assets/images/gif/loading-spinner-grey.gif" align="">*/
            ...
            html = '<div class="loading-message ' +
                (options.boxed ? 'loading-message-boxed' : '') +
                '"><span>  ' + (options.message ? options.message : 'LOADING...') + '</span></div>'; /*<img src="~/assets/images/gif/loading-spinner-grey.gif" align="">*/
        }
